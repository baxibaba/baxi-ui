...
describe('Toast', () => {
  ...
  it('type success', () => {
    ...
    const elm = vm.$el.querySelector('.baxi-iconfont-success')
    expect(elm.className).to.equal('baxi-iconfont-success')
  })
  ...
  it('type failure', () => {
    ...
    const elm = vm.$el.querySelector('.baxi-iconfont-failure')
    expect(elm.className).to.equal('baxi-iconfont-failure')
  })
  ...
  it('type caution', () => {
    ...
    const elm = vm.$el.querySelector('.baxi-iconfont-caution')
    expect(elm.className).to.equal('baxi-iconfont-caution')
  })
