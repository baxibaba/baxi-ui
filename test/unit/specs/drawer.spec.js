...
describe('Drawer', () => {
  ...
  it('slot contents', () => {
    vm = createVue({
      template: `
        <baxi-drawer :visible.sync="visible">{{content}}</baxi-drawer>
      `,
      data: {
    ...
    const container = vm.$el.querySelector('.baxi-drawer-container')
