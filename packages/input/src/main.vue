<template>
  <div class="baxi-input">
    <input class="baxi-input-field"
           ref="input"
           v-model="inputValue"
           :type="_type"
           ...
           @blur="handleBlur"
           @change="handleChange"/>
    <div class="baxi-input-append"
         v-if="_showClear || _showPwdEye">
      <div class="baxi-input-clear"
           v-if="_showClear"
           @touchstart="handleClear"
           @mousedown="handleClear"
           @click="handleClear">
        <i class="baxi-iconfont-close"></i>
      </div>
      <div class="baxi-input-eye"
           v-if="_showPwdEye"
           @click="handlePwdEye">
        <i :class="eyeClass"></i>
      </div>
...
export default {
  ...
  computed: {
    ...
    eyeClass () {
      return this.formatedEye.open ? 'baxi-iconfont-eye-invisible' : 'baxi-iconfont-eye-visible'
    },
    _showPwdEye() {
